...
import { ArrowLeft, User, Mail, Lock, Target, Ruler, Weight, ChevronRight, Activity, Camera, Upload, Shield, Zap } from 'lucide-react-native';
...
export default function CreateTraineeScreen() {
    ...
    const handleCreate = async () => {
        const { name, email, password, fitnessGoal, height, weight } = form;
        
        if (!name || !email || !password || !fitnessGoal || !height || !weight) {
            Alert.alert("Required Fields", "Please complete all identity and biometric parameters.");
            return;
        }
        ...
        try {
            ...
            Alert.alert("Success", "New operative has been successfully synchronized!", [
                ...
                <View className="flex-row items-center justify-between">
                    <View className="flex-row items-center">
                        ...
                        <View>
                            ...
                            <Text className="text-white text-2xl font-black tracking-tighter mt-0.5">Asset Onboarding</Text>
                        </View>
                    </View>
                    <GlassCard className="px-5 py-2 border-white/10" intensity="low">
                        <Text className="text-primary font-black text-[9px] uppercase tracking-[3px]">NEW NODE</Text>
                    </GlassCard>
                </View>
            </View>
                ...
                >
                    <View className="mb-10">
                        <View className="flex-row items-center mb-6 ml-1">
                            ...
                            <Text className="text-[9px] font-black text-text-muted uppercase tracking-[4px] opacity-60">Identity Parameters</Text>
                        </View>
                    ...
                    <View className="mb-10">
                        <View className="flex-row items-center mb-6 ml-1">
                            <Activity size={14} color="#a855f7" className="mr-3 opacity-60" />
                            <Text className="text-[9px] font-black text-text-muted uppercase tracking-[4px] opacity-60">Biometric Initialization</Text>
                        </View>
                        
                        <GlassCard className="p-7 border-white/5" intensity="medium">
                            <InputField 
                                label="Directive Objective"
                                icon={Target}
                                placeholder="e.g. CORE STRENGTH..."
                                value={form.fitnessGoal}
                                onChangeText={(t: string) => setForm(f => ({ ...f, fitnessGoal: t }))}
                            />
                            ...
                            <View className="flex-row space-x-6">
                                <View className="flex-1">
                                    <InputField 
                                        ...
                                        placeholder="180"
                                        value={form.height}
                                        onChangeText={(t: string) => setForm(f => ({ ...f, height: t }))}
                                ...
                                <View className="flex-1">
                                    <InputField 
                                        ...
                                        placeholder="75"
                                        value={form.weight}
                                        onChangeText={(t: string) => setForm(f => ({ ...f, weight: t }))}
                                        keyboardType="numeric"
                                    />
                                </View>
                            </View>
                        ...
                        >
                            {isLoading ? (
                                ...
                                <>
                                    ...
                                    <Text className="text-obsidian font-black text-[11px] uppercase tracking-[4px]">Synchronize Asset</Text>
